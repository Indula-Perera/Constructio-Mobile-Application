...
public class AddSupervisorCustomAdapter extends RecyclerView.Adapter<AddSupervisorCustomAdapter.SupervisorViewHolder> {
  private   Context context;
  Activity activity;
  private   ArrayList supervisor_id, supervisor_name, supervisor_email, supervisor_password, supervisor_c_password;

    public AddSupervisorCustomAdapter(Activity activity, Context context, ArrayList supervisor_id, ArrayList supervisor_name, ArrayList supervisor_email, ArrayList supervisor_password, ArrayList supervisor_c_password){
    ...
    @Override
    public void onBindViewHolder(@NonNull SupervisorViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.supervisor_row.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, UpdateSupaervisor.class);
