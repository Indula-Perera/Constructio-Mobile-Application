...
public class MasonryCustomAdapter extends RecyclerView.Adapter<MasonryCustomAdapter.MasonryViewHolder> {
    ...
    public MasonryCustomAdapter(Activity activity, Context context, ArrayList m_id, ArrayList m_name, ArrayList m_address, ArrayList m_nic, ArrayList m_age, ArrayList ms_name){
    ...
    public void onBindViewHolder(@NonNull MasonryViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.masonry_row.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, UpdateMasonry.class);
